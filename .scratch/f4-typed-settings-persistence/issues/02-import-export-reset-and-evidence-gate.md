...
- [x] Manual macOS QA ghi nhận relaunch persistence, recovery notice, import/export scope, normal reset, và credential-deletion separation; mọi scenario unrun phải được ghi rõ.
...
2026-09-15 — Maintainer confirmed applicable native F4 relaunch, recovery, import/export, and
reset-scope behavior. Credential deletion remains out of F4 scope and is not claimed as a shipped
F4 flow. Ticket 02 and the F4 evidence gate are resolved.
